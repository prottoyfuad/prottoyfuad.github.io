document.addEventListener('DOMContentLoaded', () => {
  ...
  toggleBtn.className = 'theme-switcher';
...
// To prevent flash of unstyled content, this script should ideally run in head, but appending the button is fine in DOMContentLoaded.
// The data-theme check can also be placed inline in the head for better UX.
